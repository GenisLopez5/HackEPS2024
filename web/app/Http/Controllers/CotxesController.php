...
class CotxesController extends Controller
{
    ...
    public function update(Request $request){
        ...
        $parking->occupied = $request->input('occupied');
        $parking->save();
        return response()->json(['success' => true, 'message' => 'Parking updated successfully']);
    }

    // simple delete api function
    public function delete(Request $request){
        ...
        $parking->delete();
        return response()->json(['success' => true, 'message' => 'Parking deleted successfully']);
    }
