    ...
    public function createHardcodedParking()
{
    ...
    // Parking 22
    $parking = new Parking();
    $parking->name = 'Parking Carrer Governador Montcada, 17 ';
    $parking->address = 'Carrer Governador Montcada, 17';
    $parking->city = 'Lleida';
    $parking->state = 'Catalunya';
    $parking->zip = '25002';
    $parking->capacity = 10;
    $parking->occupied = 0;
    $parking->lat = 41.613706918387706;
    $parking->lng = 0.6221770872669381;
    $parking->save();
}
