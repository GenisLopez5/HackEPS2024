...
def calc_daily(parkingID):
    ...
    historic_data_path = parkingID + '_historic_data.csv'
    daily_data_path = parkingID + '_daily_data.csv'
    today_predictions_data_path = parkingID + '_today_predictions.csv'
    tomorrow_predictions_data_path = parkingID + '_tomorrow_predictions.csv'
